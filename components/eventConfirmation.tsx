...
export const EventConfirmationEmail = ({ data }) => {
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Heading className="text-black text-[18px] font-normal text-center p-0 my-[30px] mx-0">
              <strong>Tu registro en el evento ha sido confirmado 🎉</strong>
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Hola {data?.name},
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
              Nos alegra que asistas al evento:{" "}
              <strong className="capitalize">{String(data?.eventName)}</strong>,
              a realizarle el <strong>{String(data?.eventDate)}</strong>.
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
              Este evento cuenta con la protección de Cryptohuella, te ponemos a
              disposición{" "}
              <strong>Código QR que presentarás para ingresar al evento</strong>
              . 🎟️😲
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
              Te esperamos. 😃
